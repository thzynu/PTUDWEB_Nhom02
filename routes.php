...
// Journalist routes (requires journalist or admin role)
$router->get('/journalist', 'JournalistController', 'index');
$router->get('/journalist/dashboard', 'JournalistController', 'index');

// Journalist Posts
$router->get('/journalist/posts', 'JournalistController', 'posts');
$router->get('/journalist/post/create', 'JournalistController', 'createPost');
$router->post('/journalist/post/store', 'JournalistController', 'storePost');
$router->get('/journalist/post/edit/{id}', 'JournalistController', 'editPost');
$router->post('/journalist/post/update/{id}', 'JournalistController', 'updatePost');
$router->get('/journalist/post/delete/{id}', 'JournalistController', 'deletePost');

// Journalist Comments
$router->get('/journalist/comments', 'JournalistController', 'comments');
$router->get('/journalist/comment/approve/{id}', 'JournalistController', 'approveComment');
$router->get('/journalist/comment/reject/{id}', 'JournalistController', 'rejectComment');
$router->get('/journalist/comment/delete/{id}', 'JournalistController', 'deleteComment');
