...
<head>
    <title>Đăng nhập - Tin Tức Trực Tuyến</title>
    <meta charset="UTF-8">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 auth-image">
                            <div class="text-center">
                                ...
                                <p class="mb-4">
                                    Kết nối với những tin tức và cập nhật mới nhất.
                                </p>
                        ...
                        <div class="col-lg-6">
                            <div class="auth-content">
                                <div class="text-center mb-4">
                                    ...
                                    <p class="text-muted">Nhập thông tin đăng nhập để truy cập bảng điều khiển</p>
                                </div>
