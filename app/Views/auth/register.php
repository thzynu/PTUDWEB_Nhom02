...
<html lang="en">
<head>
    <title>Đăng ký - Tin Tức Trực Tuyến</title>
    <meta charset="UTF-8">
                        ...
                        <div class="col-lg-6">
                            <div class="auth-content">
                                <div class="text-center mb-4">
                                    <h3 class="fw-bold text-dark mb-2">Tạo tài khoản của bạn</h3>
                                    <p class="text-muted">Tham gia cộng đồng và cập nhật tin tức mới nhất</p>
                                </div>
