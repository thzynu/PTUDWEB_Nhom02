    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center p-3">
                ...
                <h6 class="card-title mb-1">Tổng Bài viết</h6>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center p-3">
                ...
                <h6 class="card-title mb-1">Đã xuất bản</h6>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center p-3">
                ...
                <h6 class="card-title mb-1">Bản nháp</h6>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm bg-light">
            <div class="card-body text-center p-3">
                ...
                <h6 class="card-title mb-2">Hành động nhanh</h6>
    ...
    <div class="card-header bg-white border-0">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex gap-2">
                ...
                <input id="searchInput" type="search" class="form-control form-control-sm" placeholder="Tìm kiếm bài viết..." style="width: 200px;">
            </div>
        </div>
    </div>
            ...
            <table id="articlesTable" class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th scope="col" class="border-0 text-center">Lượt xem</th>
                    ...
                    <div class="btn-group-vertical" role="group">
                        <div class="btn-group mb-1" role="group">
                            <a href="<?= url('admin/post/breaking-news/' . $post['id']) ?>" 
                               ...
                               title="<?= $post['breaking_news'] == 2 ? 'Hủy tin nóng' : 'Đặt tin nóng' ?>">
                                <i class="fas fa-bolt"></i>
                            </a>
                            <a href="<?= url('admin/post/selected/' . $post['id']) ?>" 
                               class="btn btn-outline-<?= $post['selected'] == 2 ? 'primary' : 'secondary' ?> btn-sm" 
                               title="<?= $post['selected'] == 2 ? 'Hủy nổi bật' : 'Đặt nổi bật' ?>">
                                <i class="fas fa-star"></i>
                            </a>
                        </div>
                        <div class="btn-group" role="group">
                            <a href="<?= url('admin/posts/' . $post['id'] . '/edit') ?>" class="btn btn-outline-primary btn-sm" title="Sửa">
            ...
            <tr>
                <td colspan="7" class="text-center py-5">
                    <div class="py-4">
                        ...
                        <h5 class="text-muted mb-3">Không tìm thấy bài viết</h5>
                        <p class="text-muted mb-4">Bạn chưa tạo bài viết nào. Hãy bắt đầu bằng cách tạo bài viết đầu tiên.</p>
    ...
    tableRows.forEach((row, index) => {
        ...
        if (cells.length > 0) {
            ...
            articlesData.push({
                ...
                hasBreaking: Array.from(statusBadges).some(badge => badge.textContent.includes('Tin nóng')),
                hasFeatured: Array.from(statusBadges).some(badge => badge.textContent.includes('Nổi bật')),
                isPublished: Array.from(statusBadges).some(badge => badge.textContent.includes('Đã xuất bản'))
            });
        }
    });
