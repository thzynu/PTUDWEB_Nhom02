    ...
    <div class="main-content">
        ...
        <nav class="top-navbar">
            <div class="d-flex align-items-center">
                ...
                <h5 class="mb-0 text-dark">Hệ thống Quản lý Nội dung</h5>
            </div>
            <div class="d-flex align-items-center">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?= url('journalist') ?>" target="_blank"><i class="fas fa-newspaper me-2 text-success"></i>Panel Nhà báo</a></li>
                        <li><a class="dropdown-item" href="<?= url('/') ?>" target="_blank"><i class="fas fa-globe me-2"></i>Xem trang web</a></li>
                        <li><hr class="dropdown-divider"></li>
